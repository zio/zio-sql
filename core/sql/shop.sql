...
create table users
(
    usr_id uniqueidentifier primary key default newid() not null,
...
create table orders
(
    order_id uniqueidentifier primary key default newid() not null,
...
(
    product_id uniqueidentifier primary key default newid() not null,
...
insert users
    (usr_id, first_name, last_name, dob)
values
...
insert products
    (product_id, product_name, description, image_url)
values
