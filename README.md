...
* **No magic**. ZIO SQL does not need any plug-ins to operate (everything is a value!), and it works across Scala 2.x. Optionally, Scala schema can be created from database schemas.
